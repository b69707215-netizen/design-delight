...
export const translations = {
  ru: {
    nav: { home: "Главная", programs: "Программы", about: "О нас", contact: "Контакт", cabinet: "Кабинет", login: "Войти" },
    heroKicker: "Твой путь к гроссмейстерскому уровню",
    heroText: "Учись стратегии у мастеров спорта, думай на несколько ходов вперед и побеждай уверенно.",
    ctaTrial: "Записаться на урок",
    ctaPrograms: "Посмотреть программы",
    audiences: [
      ["♙", "Для детей", "Превращаем обучение в интеллектуальное приключение, которое развивает внимание и мышление."],
      ["♘", "Для взрослых", "Помогаем начать с нуля или вернуть форму через системный, спокойный прогресс."],
      ["♕", "Для профи", "Даём инструменты серьёзной подготовки: анализ, репертуар и турнирную дисциплину."],
    ],
    ...
    aboutText: "Gross Academy — это экосистема интеллектуального развития, где шахматы становятся языком стратегического мышления, дисциплины и уверенных решений.",
    advantages: [
      ["Персональная стратегия", "Адаптируем темп, цели и план занятий под каждого ученика."],
      ["Современная экосистема", "Объединяем классическую школу, интерактивную практику и анализ партий."],
    ...
    form: { program: "Программа", name: "Имя", surname: "Фамилия", email: "Эл. почта", phone: "Телефон", submit: "Отправить", success: "Спасибо за заявку! Мы скоро свяжемся с вами." },
    footer: "Твой путь к гроссмейстерскому уровню",
  },
  en: {
    nav: { home: "Home", programs: "Programs", about: "About", contact: "Contact", cabinet: "Cabinet", login: "Sign in" },
    heroKicker: "Your path to grandmaster-level thinking",
    heroText: "Learn strategy from titled coaches, think several moves ahead, and win with confidence.",
    ...
    aboutText: "Gross Academy is an intellectual development ecosystem where chess becomes a language of strategic thinking, discipline, and confident decisions.",
    advantages: [
    ...
    form: { program: "Program", name: "First name", surname: "Last name", email: "Email", phone: "Phone", submit: "Send", success: "Thank you! We will contact you soon." },
